...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/Assignment_war_exploded/cart/checkout"; // đây là link khi nó thanh toán thành công nó trả về link này,oke
    ...
    public static String hashAllFields(Map fields) {
        ...
        sb.append(com.dienthoaiviet.controler.webstite.Config.vnp_HashSecret);
