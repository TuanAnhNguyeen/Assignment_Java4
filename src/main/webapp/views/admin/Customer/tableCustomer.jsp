        ...
        <div class="container-fluid">
                        ...
                        <ol class="breadcrumb float-right">
                            <div class="card-header">
                                <button type="button" class="btn btn-primary">
                                    <i class="fas fa-user-plus"></i><a class="btn btn-primary" href="<%=request.getContextPath()%>/admin/customer/add">Thêm Khách Hàng</a> </button>
                            </div>
                        </ol>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3><i class="fas fa-table"></i>Bảng Khách Hàng</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable1" class="table table-striped table-bordered zero-configuration" >
                                    ...
                                    <tbody>
                                    <c:forEach  var="item" items="${listCustomer}" varStatus="index">
                                        <tr>
                                            <td> ${index.index +1}</td>
                                            <td>${item.fullname}</td>
