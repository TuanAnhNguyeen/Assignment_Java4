...
<head>
	...
	<!--Stylesheets-->
	<link href="<%=request.getContextPath()%>/views/admin/css/jquery.filer.css" type="text/css" rel="stylesheet" />
	<link href="<%=request.getContextPath()%>/views/admin/css/themes/jquery.filer-dragdropbox-theme.css" type="text/css" rel="stylesheet" />

	<!--jQuery-->
	<script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/views/admin/js/jquery.filer.min.js?v=1.0.5"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/views/admin/js/custom.js?v=1.0.5"></script>
