        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3><i class="fas fa-table"></i>Bảng Hóa Đơn Chờ Xác Nhận</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable1" class="table table-striped table-bordered zero-configuration" >
                                    ...
                                    <tbody>
                                    <c:forEach var="item" items="${listBillAll_Status_confrim}" varStatus="index">
                                        <tr>
                                            <td>${index.index+1}</td>
                                            <td>PH100${item.id}</td>
                                            ...
                                            <td style="width: 250px">
                                                <a href="<%=request.getContextPath()%>/admin/bill/xacnhan/hoadon?id=${item.id}" class="btn btn-secondary ">Xem</a>
                                                <a href="<%=request.getContextPath()%>/admin/cart/huydoncho?id=${item.id}" class="btn btn-danger">Huy</a>
                                                <a href="<%=request.getContextPath()%>/admin/cart/xacnhandoncho?id=${item.id}" class="btn btn-primary ">Xác Nhận</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
