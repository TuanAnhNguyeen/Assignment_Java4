        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3><i class="fas fa-table"></i>Bảng Hóa Đơn Đã Thanh Toán</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable1" class="table table-striped table-bordered zero-configuration" >
                                    ...
                                    <tbody>
                                    <c:forEach var="item" items="${listBillAll_Status}" varStatus="index">
                                        <tr>
                                            <td>${index.index+1}</td>
                                            <td>PH100${item.id}</td>
                                            ...
                                            <td>
                                                <a href="<%=request.getContextPath()%>/admin/bill/dathanhtoan?id=${item.id}" class="btn btn-primary btn-sm btn-block"><i class="far fa-edit"></i>Xem Chi Tiết</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
